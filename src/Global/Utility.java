...
public class Utility {
    ...
    public static void howToPlay(Scanner sc) {
        ...
        switch (choice) {
            ...
            case 3:
                System.out.println(
                        "You can navigate between different zones by using the travel menu. You may travel to the Forest or the Swamp freely but advancing more requires you to explore these zones.");
                System.out.println(
            ...
            case 5:
                System.out.println(
                        "You can rest and shop for items in the tavern. Resting will restore your health and shopping will allow you to buy items.");
