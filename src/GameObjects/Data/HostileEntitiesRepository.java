...
public class HostileEntitiesRepository {
	...
	public static HostileCharacter getStuntedMudTroll() {
		return new HostileCharacter("Stunted Mud Troll", 30, 1, 30, 1, 1, HostileEntityType.TROLLKIN,"Description");
	}
	...
	public static HostileCharacter getGiantBloodsuckingBat() {
		return new HostileCharacter("Giant Bloodsucking Bat", 5, 2, 3, 5, 1, HostileEntityType.UNDEFINED,"Description");
	}
