...
public class Info {
    public static void howToPlay(Scanner sc) {
        ...
        while (!exitMenu) {
            ...
            switch (choice) {
                case 1:
                    System.out.println(
                            "Your character has different stats that determine how well they perform in different situations.\nHealth: Determines how much damage you can take before you die.\nStrength: Determines how much damage you deal in combat.\nDexterity: Determines your defensive capabilities\nIntelligence: Determines the order in combat.\nExperience: Determines how close you are to leveling up.");
                    Utility.promptEnterKey(sc);
                    Utility.clearConsole();
                    break;
                case 2:
                    System.out.println(
                            "Combat is turn-based. You and your enemy take turns attacking each other.\nYou can choose to attack, use an item, or run away.\nThe combat ends when either you or your enemy's health reaches 0.");
                    Utility.promptEnterKey(sc);
                    Utility.clearConsole();
                    break;
                case 3:
                    System.out.println(
                            "You can navigate between different zones by using the travel menu. You may travel to the Forest or the Swamp freely at the start but advancing more requires you to explore these zones.");
                    Utility.promptEnterKey(sc);
                    Utility.clearConsole();
                    break;
                case 4:
                    System.out.println(
                            "You can interact with items by choosing to use them in the inventory menu.\nYou can also inspect items to view their descriptions and effects.");
                    Utility.promptEnterKey(sc);
                    Utility.clearConsole();
                    break;
                case 5:
                    System.out.println(
                            "You can rest and shop for items in the tavern. Resting will restore your health, and you can buy or sell items from the shopkeeper.");
                    Utility.promptEnterKey(sc);
                    Utility.clearConsole();
                    break;
                case 0:
    ...
    public static void gameIntro() {
        ...
        System.out.println(Utility.GREEN
                + "/    ~    \\_/ __ \\_  __ \\/  _ \\/  ___/    \\_____\\__  \\|_   _|   ~    \\ " + Utility.RESET);
        System.out.println(Utility.GREEN
                + "\\    Y    /\\  ___/|  | \\(  <_> )___ \\      |  |_> > __ \\| |\\    Y    /" + Utility.RESET);
        System.out.println(Utility.GREEN + " \\___|_  /  \\___> |  |   \\____/____  >     |   __(____  / | \\___|_  / "
                + Utility.RESET);
        System.out.println(Utility.GREEN + "       \\/          \\/              \\/      |__|         \\/        \\/ "
                + Utility.RESET);
        System.out.println();
